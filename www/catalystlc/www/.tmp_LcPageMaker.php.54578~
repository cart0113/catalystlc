<?php
require_once("file:///C:/xampp/projects/Ox/OxLibs/OxPage.php");
require_once("file:///C:/xampp/projects/Ox/OxLibs/OxForm/OxForm.php"); 
require_once("file:///C:/xampp/projects/Ox/OxLibs/OxForm/OxFormBlock.php"); 
require_once("file:///C:/xampp/projects/Ox/OxLibs/OxForm/OxTagInput.php"); 
...
//			getQuote($n);		
			...
			$textAlls[] = "
				<p>
					We offer both homework help and one-on-one individualized math learning programs that help students master the critical 
                    mathematical concepts they need to pass
                    <a href='http://www.education.state.mn.us/mde/Accountability_Programs/Assessment_and_Testing/'>
                        Graduation
                        Requirement Examinations (GREs)
                    </a> and college entrance examinations. 
					
					
					To most effectively execute on our mission, 
					we are creating assessment and teaching materials centered around the Minnesota Comprehension Assessment Series II (MCA-II)
					math examinations. 
				</p>
				We are founded on the premise that 
                every student will excel academically if given the access and time to master
                all necessary prerequisite knowledge.
				$more0  
			";
		...
		$textAlls[] = " 
				<p>
					...
					teachers, tutors, and computer programmers who want to make tutoring more efficient and effective. $more1010
				</p>
				<p>  
					Currently, Catalyst is not funded, is entirely a volunteer effort, and 
					are generously being housed by 
					<a href='http://www.urbanventures.org'>Urban Ventures</a>
					-- a dedicated nonprofit operating in the South Minneapolis area.  We are currently
					running a small pilot project at Urban Ventures using our new MCA-II materials. 
					$more55
				</p>
...
//				</p>
			...
			$text = 
				...
				<br/><br/>
				Catalyst is creating its own assessment and teaching 'printables' -- pdf documents
				tutors can easily locate, download, and print out.  This way, tutors have the materials
				...
				face-to-face one-on-one tutoring sessions.  Further, they 1) integrate with our online
				tracking database and 2) help us enforce consistency and <a href='./pdf.php?pdf=approach.pdf'>our 
				standards based educational approach</a>. 
				Please <a href='./contact.php'>contact us</a> for access to our full library and our beta version online tracking
				database. 
				<br/><br/>
